...
public class Message extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -6176606989222086087L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Message\",\"namespace\":\"com.xiaofen.protocol\",\"fields\":[{\"name\":\"id\",\"type\":\"string\"},{\"name\":\"msg\",\"type\":\"string\"}]}");
   ...
   */
  public static com.xiaofen.protocol.Message.Builder newBuilder() {
    return new com.xiaofen.protocol.Message.Builder();
  }
   ...
   * @return A new Message RecordBuilder
   */
  public static com.xiaofen.protocol.Message.Builder newBuilder(com.xiaofen.protocol.Message.Builder other) {
    return new com.xiaofen.protocol.Message.Builder(other);
  }
   ...
   * @return A new Message RecordBuilder
   */
  public static com.xiaofen.protocol.Message.Builder newBuilder(com.xiaofen.protocol.Message other) {
    return new com.xiaofen.protocol.Message.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Message>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.xiaofen.protocol.Message.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.xiaofen.protocol.Message other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.xiaofen.protocol.Message.Builder setId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.xiaofen.protocol.Message.Builder clearId() {
      id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.xiaofen.protocol.Message.Builder setMsg(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.xiaofen.protocol.Message.Builder clearMsg() {
      msg = null;
